...
public class UsuariosController
{
    ...
    @Operation(
            ...
            description = "Dado un id, devuelve un el usuario, en caso contrario no devuelve nada"
    )
    ...
    @Operation(
            ...
            description = "Crea un nuevo usuario validando el email, el nombre y la contraseña. Devuelve el usuario creado si todo es correcto."
    )
    ...
    @Operation(
            ...
            description = "A partir de un email y una contraseña devuelve una respuesta afirmativa o negativa"
    )
    public ResponseEntity<?> Login(@RequestBody Usuarios usuario)
    {
         return usuariosService.Login(usuario.getEmail(), usuario.getPassword());
    }
    ...
    @Operation(
            ...
            description = "Actualiza al usuario mediante un id y un objeto Usuario (obligatorio esto para actualizar)"
    )
    ...
    @Operation(
            ...
            description = "Elimina al usuario de la base de datos, si no lo encuentra no hace nada"
    )
